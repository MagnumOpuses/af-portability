...
import se.arbetsformedlingen.matchning.portability.builder.CommunicationTypeBuilder;
import se.arbetsformedlingen.matchning.portability.builder.PersonNameTypeBuilder;
...
public class CandidatePersonTypeBuilder {
    private CandidatePersonType candidatePersonType = new CandidatePersonTypeBuilder().createCandidatePersonType();
    ...
    public se.arbetsformedlingen.matchning.portability.builder.CandidatePersonTypeBuilder withPersonUppgifter(PersonUppgifter personUppgifter){
