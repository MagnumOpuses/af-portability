...
public class EmailTypeArray {
    ...
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2020-02-18T10:16:43+01:00", comments = "JAXB RI v2.2.8-b130911.1802")
    protected List<EmailTypeArray.Item> item;
     ...
     * {@link EmailTypeArray.Item }
     * 
     * 
     */
    @Generated(value = "com.sun.tools.internal.xjc.Driver", date = "2020-02-18T10:16:43+01:00", comments = "JAXB RI v2.2.8-b130911.1802")
    public List<EmailTypeArray.Item> getItem() {
        if (item == null) {
            item = new ArrayList<EmailTypeArray.Item>();
        }
        return this.item;
    }

    public EmailTypeArray withItem(String emailAddress){
        EmailTypeArray.Item item = null;
        item.setAddress(emailAddress);
        getItem().add(item);
        return this;
    }
